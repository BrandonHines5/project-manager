 ...
 * chips, the review queue for documents that couldn't be auto-matched or
 * auto-classified, and manual upload / send-request tools. All data is
 * staff-RLS'd; clients and trades never reach this route (requireStaff
 * redirects).
 */
export default async function VendorDocumentsPage() {
  ...
  //   * processed W9s/SMAs/others — the Docs chips, expanded-row lists, and export
